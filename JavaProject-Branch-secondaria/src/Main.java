...
import universo.Tempo;   //cartella universo classe tempo
import universo.Universo;  //cartella universo classe universo 
import GlobalVar.Variabile;  //cartella GlobalVar classe variabile
...
public class Main {
    ...
    public static void main(String[] args){
        ...
        for(int i = 0; i< args.length; i++){
            ...
            if(args[i].startsWith("-")){   //inizia con (startsWith)
                switch (args[i]){		  //l'argomento a quella determinata i ha un valore , se nessuno soddisfa i casi fai di default  
